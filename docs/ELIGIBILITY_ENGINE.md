...
A legal-hours blocker additionally requires an exact-unit fortnight value and a verified, deterministically applicable time basis: explicit current, an active date window, or a verified teaching/break/visa period marked as applying now. Missing, unverified, expired, or unresolved period applicability yields `REVIEW_REQUIRED`, not a legal conclusion. Weekly evidence never becomes fortnightly evidence.
