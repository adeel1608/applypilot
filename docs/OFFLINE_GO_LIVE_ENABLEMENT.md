...
- Lever read-only real-target inspection lane: v5 is offline-hardened; a fresh v5-family approval and separate owner start would be required for any future controlled validation.
