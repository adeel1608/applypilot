...
- Lever read-only real-target inspection lane: v4 is offline-hardened; a fresh v4-family approval and separate owner start would be required for any future controlled validation.
