...
- Remaining checkpoint: rerun all checks after this plan update, commit/push the complete implementation, open an unmerged pull request into `main`, wait for GitHub CI, record the exact commit/PR/run results here, push that checkpoint, wait for final CI, and stop for human review. Phase 2.6 and Phase 3 remain unstarted.
