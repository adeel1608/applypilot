...
- Remaining checkpoint: commit/push the intended documentation diff, open an unmerged pull request into `main`, wait for final CI, and stop for human review. Phase 2.5A operation, the backup-ignore fix, real profile setup, real vacancy import, Phase 2.6, and Phase 3 are not started.
