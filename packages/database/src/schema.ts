...
export const sourceCapabilityVersions = sqliteTable("source_capability_versions", {
  id: text("id").primaryKey(),
  ...
  policyVersion: text("policy_version").notNull(),
  policyReviewedAt: text("policy_reviewed_at").notNull(),
...
export const sourceRunCheckpoints = sqliteTable("source_run_checkpoints", {
  ...
  seenPageDigestsJson: text("seen_page_digests_json").notNull(),
  requestCount: integer("request_count").notNull(),
  ...
  ownerStartedAt: text("owner_started_at").notNull(),
  ownerCancelledAt: text("owner_cancelled_at"),
  completedAt: text("completed_at"),
  createdAt: text("created_at").notNull(),
  updatedAt: text("updated_at").notNull(),
});
...
export const runnerTargetCapabilityVersions = sqliteTable("runner_target_capability_versions", {
  id: text("id").primaryKey(),
  capabilityId: text("capability_id").notNull(),
  version: integer("version").notNull(),
  predecessorId: text("predecessor_id"),
...
export const runnerRunBindings = sqliteTable("runner_run_bindings", {
  id: text("id").primaryKey(),
  runId: text("run_id").notNull(),
...
export const runnerRecoveryEvents = sqliteTable("runner_recovery_events", {
  id: text("id").primaryKey(),
  runId: text("run_id").notNull(),
  sequence: integer("sequence").notNull(),
  decision: text("decision").notNull(),
